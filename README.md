# This project has been discontinued [in favor of Umbraco Headless](https://umbraco.com/products/umbraco-headless/)

## We're no longer making any updates to this project
## You're welcome to clone the project and continue using and altering it but Umbraco HQ does no longer support it
...
### Below is the archived readme and documentation
...
## Below is the documentation migrated from Our Umbraco
